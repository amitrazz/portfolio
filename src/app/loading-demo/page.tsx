...
export default function LoadingDemoPage() {
  ...
  return (
    <main className="min-h-screen py-16 px-4 md:px-8 max-w-[58rem] mx-auto flex flex-col gap-12 w-full">
      ...
      {isLoading ? (
        <div className="flex flex-col gap-16 w-full">
          ...
          <section className="w-full">
            <h2 className="text-sm font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500 mb-6 text-center">
